...
export function RegisterLoginData() {
  ...
  async function handleRegister(formData: FormData) {
    ...
    const getStoragedData = await AsyncStorage.getItem(dataKey);

    if (getStoragedData) {
      const formattedStrageData = JSON.parse(getStoragedData);

      await AsyncStorage.setItem(
        dataKey,
        JSON.stringify([...formattedStrageData, newLoginData])
      );
